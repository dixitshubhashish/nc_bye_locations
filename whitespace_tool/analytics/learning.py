"""Machine learning heuristics for template-assisted field mapping suggestions.

Analyzes historical saved workflow templates to infer and suggest target-to-source
field mappings for new data ingestion tasks.
"""
...
def _clean(value: Any) -> str:
    """Normalize string input by lowercasing and stripping non-alphanumeric characters."""
