"""Unit tests for dataset clear operations and soft-delete/truncate routing.

Tests soft-deletion of transactional tables and truncation of audit logs.
"""
...
from whitespace_tool.persistence.warehouse_bigquery import _clear_dataset_tables_with_client
...
class _FakeClient:
    """Mock BigQuery client returning dataset table listings and recording executed queries."""
...
class ClearSavedDataTests(unittest.TestCase):
    """Test suite for validating dataset clear and soft-delete mechanics."""

    def test_soft_deletes_known_tables_and_truncates_other_clearable_tables(self) -> None:
        """Verify clear_dataset_tables soft-deletes transactional tables and truncates audit runs."""
        client = _FakeClient([
            "us_zipcodes",
            "field_catalogs",
            "source_types",
