"""Unit tests for OpenStreetMap Overpass API fallback source loader.

Tests element conversion, query execution, store schema output, and ZIP code parameters.
"""
...
class DominosOverpassTests(unittest.TestCase):
    """Test suite for OpenStreetMap Overpass API Domino's location retrieval."""

    def test_fetch_for_zips_outputs_dominos_store_shape(self) -> None:
        """Verify fetch_for_zips transforms Overpass nodes and ways to store dictionaries."""
        elements = {
            "10001": [
                {
                    "type": "node",
