"""Unit tests for demonstration dataset loading and validation routing rules.

Tests validation of predefined brand templates and error routing for malformed or missing fields.
"""
...
from whitespace_tool.mapping.ingestion import save_mapper
from whitespace_tool.templates.services import predefined_templates


class DemoDataValidationTests(unittest.TestCase):
    """Test suite for verifying predefined demo templates and validation error routing."""
